import "../../Styles/Layout/Privacypolitics.css";
...
function Privacypolitics() {
  return (
    <div className="privacypolitics">
      ...
      <p>
        Las palabras cuyas letras iniciales se escriben en mayúscula tienen
      ...
      <ul>
        <li>
          Se refiere a una cuenta única creada para que Usted acceda a nuestro
          Servicio o a partes de nuestro Servicio.
        </li>
        <li>
          Significa una entidad que controla, es controlada por o está bajo
          control común con una parte, donde "control" significa la propiedad
          del 50% o más de las acciones, participaciones en el capital u otros
          valores con derecho a voto para la elección de directores u otra
          autoridad administrativa.
        </li>
      </ul>
      <p>
        La Compañía (denominada "la Compañía", "Nosotros", "Nos" o "Nuestro" en
        este Acuerdo) se refiere a Marketing digital de chihuahua S.A de C.V,
        Chihuahua, Chihuahua.
      </p>
      <p>
        Las cookies son pequeños archivos que un sitio web coloca en su
        ordenador, dispositivo móvil o cualquier otro dispositivo, que contienen
        los detalles de su historial de navegación en ese sitio web entre sus
        muchos usos.
      </p>
      <ul>
        <li>Se refiere a: México</li>
        <li>
          Se refiere a cualquier dispositivo que pueda acceder al Servicio, como
          una computadora, un teléfono celular o una tableta digital.
        </li>
      </ul>
      <p>
        Los Datos de uso se refieren a los datos recopilados automáticamente, ya
        sea generados por el uso del Servicio o de la propia infraestructura del
        Servicio (por ejemplo, la duración de una visita a la página). El sitio
        web se refiere a The Bird Crew, accesible desde thebirdcrew.com
      </p>
      <ul>
        <li>
          Se refiere a la persona que accede o utiliza el Servicio, o a la
          empresa u otra entidad legal en nombre de la cual dicha persona accede
      ...
      <p>
        ...
        políticas legales. La Empresa también conservará los Datos de Uso con
        fines de análisis interno. Por lo general, los datos de uso se conservan
        durante un período de tiempo más corto, excepto cuando estos datos se
        utilizan para reforzar la seguridad o mejorar la funcionalidad de
        nuestro servicio, o cuando estamos legalmente obligados a conservar
